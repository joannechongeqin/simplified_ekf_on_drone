...
namespace ee4308::turtle
{
    ...
    { // contains defaults that can be overwritten
        ...
        std::string frame_id = "/world";    // The parent tf2 frame of the costmaps
        V2 size = {200, 200};            // Number of cells, in {width, height}, which is number of cells in x and y axis respectively.
        V2d origin = {-5, -5};         // World coordinates of the bottom-left corner (-x and -y direction from center) of the grid.
    ...
    public:
            ...
            : Node(name)
        {
            ...
            // RCLCPP_INFO_STREAM(this->get_logger(), "Mapper node initialized!");
        }
